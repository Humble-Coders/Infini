...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-md border border-input bg-input-background px-3 py-2 text-sm text-foreground whitespace-nowrap",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-accent/15 focus:bg-accent/15 focus:text-accent",
