...
const TRACES = [
  ...
  },
  {
    ...
    step: "03",
    title: "Waviness",
    caption: "Longer-wavelength undulation left by the machine tool. Removed.",
    values: waviness,
    kept: false,
  },
  {
    ...
    step: "04",
    title: "Roughness",
    caption: "The short-wavelength peaks that carry stress risers and hold contaminant. Removed.",
    values: roughness,
    kept: false,
  },
  {
