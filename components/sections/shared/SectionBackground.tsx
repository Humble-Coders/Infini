...
export function SectionBackground({ grid = false, className = "" }: { grid?: boolean; className?: string }) {
  return (
    <div
      aria-hidden="true"
      className={`pointer-events-none absolute inset-0 overflow-hidden text-foreground/70 ${className}`}
    >
      <PrecisionMark
